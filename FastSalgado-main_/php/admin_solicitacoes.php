    ...
    try {
        ...
        if ($solicitacao) {
            if ($_POST['action'] === 'approve') {
                $insertSql = "INSERT INTO imoveis (endereco, cidade, categoria, preco, nome_vendedor, telefone_vendedor, email_vendedor, foto, descricao, status, latitude, longitude, usuario_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'disponível', ?, ?, ?)";
