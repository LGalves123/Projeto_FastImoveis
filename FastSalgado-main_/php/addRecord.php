<?php
session_start(); // Iniciar sessão para obter o id do usuário logado
...
if (!isset($_SESSION['idUsuario'])) {
    die("Erro: você precisa estar logado para adicionar imóveis.");
}

$usuarioId = $_SESSION['idUsuario']; // Capturar o ID do corretor logado
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $targetFile)) {
        ...
        try {
            ...
            $sql = "INSERT INTO imoveis (endereco, cidade, categoria, preco, nome_vendedor, telefone_vendedor, email_vendedor, status, foto, descricao, usuario_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            $stmt->bindParam(11, $usuarioId); // Inserir o ID do corretor logado
