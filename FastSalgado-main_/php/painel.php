...
// Consulta SQL para buscar os imóveis, incluindo o idUsuario com junção
$query = "SELECT imoveis.*, usuarios.id AS usuario_id 
          FROM imoveis 
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="solicitarImovel.php" enctype="multipart/form-data">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($row['usuario_id'] == $usuarioId || $isAdmin) { ?>
                    <!-- Botão Editar -->
                    <i class="edit-icon icon-button" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id'] ?>">
                        <i class="fas fa-edit"></i>
                    </i>
                    <!-- Botão Excluir -->
                    <i class="delete-icon" type="button" onclick="deleteRecord(<?= $row['id'] ?>)">
